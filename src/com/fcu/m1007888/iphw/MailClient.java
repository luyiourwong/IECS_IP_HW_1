...
public class MailClient extends Frame {
	...
	public MailClient() {
		...
		/*
		 * 因為懶得每次測試都要輸入一遍, 所以這邊先設定預設值了
		 */
		serverField.setText("192.168.2.2");
		fromField.setText("M1007888@o365.fcu.edu.com");
		toField.setText("luyiourwong@gmail.com");
		subjectField.setText("smtp test");
		messageText.setText("test smtp 123");
		/*
		 * 
		 */
